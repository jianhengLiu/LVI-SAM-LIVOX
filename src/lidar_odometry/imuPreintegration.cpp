...
public:
    ...
    IMUPreintegration()
    {
        ...
        subImu = nh.subscribe<sensor_msgs::Imu>(imuTopic, 2000, &IMUPreintegration::imuHandler,
    ...
    */
    void odometryHandler(const nav_msgs::Odometry::ConstPtr &odomMsg)
    {
        ...
        if (systemInitialized == false)
        {
            ...
            // initial velocity
            // 添加速度先验因子，初始速度设为0，注意priorVelNoise非常大（1e2）
    ...
    */
    void imuHandler(const sensor_msgs::Imu::ConstPtr &imuMsg)
    {
        ...
        if (imuTime - last_path_time > 0.1)
        {
            ...
            while (!imuPath.poses.empty() && abs(imuPath.poses.front().header.stamp.toSec() -
